...
function Search({ searchValue, setSearchValue }) {
  return (
    <>
      <label className="label mx-auto my-6 flex h-12 w-80 cursor-pointer items-center overflow-hidden rounded-full border-2 border-gray-950 pl-4 pr-2 focus-within:border-green-500 dark:border-neutral-600 dark:focus-within:border-orange-600 lg:h-14 lg:w-[684px]">
        <input
